...
func (group *JoyPermissionGroup) registerHandlerPermission(permission string, handlers ...gin.HandlerFunc) {
	name := ""
	exsit := false
...
func (group *JoyPermissionGroup) GetAllPermissionName() []string {
