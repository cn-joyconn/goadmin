...
type AdminMenu struct {
	...
	PMenuID      uint32 `gorm:"index:idx_menu,priority:1;column:f_menu_id;description:菜单ID,根节点此值为0";json:"pMenuID"`
	PPid         uint32 `gorm:"column:f_pid;description:父级ID";json:"pPid"`
	PState       uint8  `gorm:"index:idx_menu,priority:2;default:1;column:f_state;description:状态1正常 0禁用";json:"pState"`
	...
	PType        uint8  `gorm:"default:1;column:f_type;description:资源类型(1菜单  2页面)";json:"pType"`
